"""kubectl/oc analytics — TUI entry point."""
...
app = typer.Typer(
    name="analytics",
    help="Kubernetes / OpenShift adoption and mesh statistics — per namespace.",
...
@app.callback()
def _global_options(
    tool: Annotated[CliTool, typer.Option(
        "--tool", "-t",
...
def run_all(
    ...
    console.print(Panel(
        f"[bold]{_state.tool.value} analytics[/bold] — all reports\n"
